...
from pettingllms.rewards.reward_fn import RewardFunction, RewardOutput
...
class TestToolEnvironment:
    ...
    def test_init_with_tools_list(self):
        ...
        with patch("pettingllms.environments.tools.tool_env.MultiTool") as mock_multi_tool:
            mock_instance = Mock()
    ...
    def test_from_dict(self):
        ...
        with patch("pettingllms.environments.tools.tool_env.MultiTool"):
