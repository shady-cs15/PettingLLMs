...
python3 -m pettingllms.trainer.train --config-path ../config/stateful --config-name stateful_L0_single_agent \
    $model_0_resource \
    models.model_0.path="your model path"\
    training.experiment_name=stateful_single_agent\
