...
[![Documentation](https://img.shields.io/badge/Documentation-black?style=for-the-badge&logo=googledocs&logoColor=white)](https://pettingllms-project.readthedocs.io/en/latest)
...
pettingllms is an open-source framework for post-training language agents via reinforcement learning. With pettingllms, you can easily build your custom agents and environments, train them with reinforcement learning, and deploy them for real-world workloads. 
...
- 📄 [Training Scripts](https://github.com/agentica-project/pettingllms/tree/main/examples/swe)
...
- 📄 [Training Scripts](https://github.com/agentica-project/pettingllms/tree/main/scripts/deepcoder/train)—Exact hyperparameters we used to achieve `o3-mini` performance.
...
Citing pettingllms:
```bibtex
@misc{pettingllms2025,
  title={pettingllms: A Framework for Post-Training Language Agents},
  ...
  year={2025},
  howpublished={\url{https://pretty-radio-b75.notion.site/pettingllms-A-Framework-for-Post-Training-Language-Agents-21b81902c146819db63cd98a54ba5f31}},
  note={Notion Blog}
  year={2025}
}
```
