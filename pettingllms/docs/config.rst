Config:
------
This document extends the `Verl configuration documentation <https://verl.readthedocs.io/en/latest/examples/config.html>`_ and describes configs introduced in pettingllms for async/partial rollout/env-agent APIs.
