...
ENVIRONMENT_IMPORTS = [
    ("pettingllms.environments.browsergym.browsergym", "BrowserGymEnv"),
    ("pettingllms.environments.frozenlake.frozenlake", "FrozenLakeEnv"),
    # ("pettingllms.environments.swe.swe", "SWEEnv"),
    ("pettingllms.environments.code.competition_coding", "CompetitionCodingEnv"),
]
