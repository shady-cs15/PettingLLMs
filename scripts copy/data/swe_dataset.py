...
import pettingllms
from pettingllms.agents.system_prompts import SWE_SYSTEM_PROMPT, SWE_USER_PROMPT
from verl.utils.hdfs_io import copy, makedirs

# Get the directory for pettingllms repo (pettingllms.__file__)
pettingllms_DIR = os.path.dirname(os.path.dirname(os.path.abspath(pettingllms.__file__)))
...
def main():
    ...
    parser.add_argument("--local_dir", default=os.path.join(pettingllms_DIR, "data/swe"))
