...
from pettingllms.data.dataset_types import TestDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default=os.path.expanduser("~/pettingllms/data"), help="Local directory to save processed datasets")
